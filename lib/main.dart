...
import 'package:holmes3/login_page/login_page_widget.dart';
...
class _MyAppState extends State<MyApp> {
  Stream<Holmes3FirebaseUser> userStream;
  Holmes3FirebaseUser initialUser;
  ...
  void initState() {
    super.initState();
    userStream = holmes3FirebaseUserStream()
